...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <br/>- Date must be ISO: YYYY-MM-DD
        /// <br/>- Date folder name is resolved using all formats configured in SharedDrive:DateFolderFormats
        /// <br/>- Requires 'query' role
        /// </remarks>
        /// <returns>OK</returns>
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<FileMetadataDto>>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<FileResponse> ContentAsync(string path)
        {
            return ContentAsync(path, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<FileResponse> ContentAsync(string path, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
    ...
    public partial class FileMetadataDto
    {
        ...
        [Newtonsoft.Json.JsonProperty("extension", Required = Newtonsoft.Json.Required.AllowNull)]
        ...
        [Newtonsoft.Json.JsonProperty("relativePath", Required = Newtonsoft.Json.Required.AllowNull)]
