...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<ReadJudicialCalendarsResponse> ReadCalendarsV2Async(string locationIds, string startDate, string endDate, string judiciaryTypes, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (locationIds != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("locationIds")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(locationIds, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    if (startDate != null)
                    {
                    ...
                    if (judiciaryTypes != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("judiciaryTypes")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(judiciaryTypes, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    urlBuilder_.Length--;
        ...
        /// <summary>
        /// Returns upcoming seized assigned cases for judges
        /// </summary>
        /// <param name="reasons">Comma-delimited reasons (e.g. DEC, ACT, CNT)</param>
        /// <param name="restrictions">Comma-delimited restrictions (e.g. G - Assigned, S - Seized, A - Appealed)</param>
        /// <returns></returns>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Case>> GetUpcomingSeizedAssignedCasesAsync(string reasons = "", string restrictions = "")
        {
            return GetUpcomingSeizedAssignedCasesAsync(reasons, restrictions, System.Threading.CancellationToken.None);
        }

        /// <summary>
        /// Returns upcoming seized assigned cases for judges with cancellation token
        /// </summary>
        /// <param name="reasons">Comma-delimited reasons (e.g. DEC, ACT, CNT)</param>
        /// <param name="restrictions">Comma-delimited restrictions (e.g. G - Assigned, S - Seized, A - Appealed)</param>
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Case>> GetUpcomingSeizedAssignedCasesAsync(string reasons, string restrictions, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/calendar/judges/upcomingSeizedAssignedCases"
                    urlBuilder_.Append("api/calendar/judges/upcomingSeizedAssignedCases");
                    urlBuilder_.Append('?');
                    if (restrictions != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("restrictions")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(restrictions, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    if (reasons != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("reasons")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(reasons, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    urlBuilder_.Length--;
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<Case>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
