...
namespace Scv.Db.Migrations
{
    ...
    [Migration("20260302120000_SignalROutbox")]
    partial class SignalROutbox
    {
            ...
            modelBuilder.Entity("Scv.Db.Models.SignalROutboxMessage", b =>
                {
                    ...
                    b.HasIndex("Channel", "DeliveredAt", "CreatedAt")
                        .HasDatabaseName("ix_signalr_outbox_message_channel_delivered_created");

                    b.HasIndex("AckGuid")
                        .IsUnique()
                        .HasDatabaseName("ix_signalr_outbox_message_ack_guid");

                    b.ToTable("signalr_outbox_message");
                });
