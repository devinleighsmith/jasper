...
namespace DARSCommon.Clients.LogNotesServices
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial interface ILogNotesServicesClient
    {

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Lognotes>> GetBaseAsync(string? region = null, int? location = null, string? room = null, System.DateTimeOffset? datetime = null, string? judge = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class LogNotesServicesClient : ILogNotesServicesClient
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public LogNotesServicesClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Lognotes>> GetBaseAsync(string? region = null, int? location = null, string? room = null, System.DateTimeOffset? datetime = null, string? judge = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("lognotes?");
            if (region != null)
            {
            ...
            if (room != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("room") + "=").Append(System.Uri.EscapeDataString(ConvertToString(room, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (datetime != null)
            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<Lognotes>>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    public partial class Lognotes
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public string Judge { get; set; } = default!;
