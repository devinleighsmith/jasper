...
namespace DARSCommon.Clients.LogNotesServices
{
    ...
    public partial class LogNotesServicesClient : ILogNotesServicesClient
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SwaggerResponse<System.Collections.Generic.ICollection<Lognotes>>> GetBaseAsync(string? region = null, int? location = null, string? room = null, System.DateTimeOffset? datetime = null, string? judge = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            ...
                            return new SwaggerResponse<System.Collections.Generic.ICollection<Lognotes>>(status_, headers_, objectResponse_.Object);
                        }
                        else
                        {
