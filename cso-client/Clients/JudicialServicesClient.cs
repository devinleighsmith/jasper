...
namespace CSOCommon.Clients.JudicialServices
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.7.0.0 (NJsonSchema v11.6.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class JudicialServicesClient : IJudicialServicesClient
    {
...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public JudicialServicesClient(string baseUrl, System.Net.Http.HttpClient httpClient)
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<FileResponse> GetJudicialDocumentAsync(System.Guid transaction_Id, double? agencyId, double documentId, DocumentApplicationName documentApplicationName, string applicationCode, string documentFlatten, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (documentApplicationName == null)
                throw new System.ArgumentNullException("documentApplicationName");

            if (applicationCode == null)
                throw new System.ArgumentNullException("applicationCode");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    request_.Headers.TryAddWithoutValidation("Transaction-Id", ConvertToString(transaction_Id, System.Globalization.CultureInfo.InvariantCulture));
                    ...
                    // Operation Path: "judicial/{documentId}/document"
                    ...
                    try
                    {
                        ...
                        if (status_ == 200 || status_ == 206)
                        {
                            ...
                            if (status_ == 400)
                            {
                                ...
                                throw new ApiException<APIError>("Request is not valid", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                            }
                            else
                                if (status_ == 401)
                                {
                                    string responseText_ = (response_.Content == null) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                                    throw new ApiException("Incorrect or no authorization provided", status_, responseText_, headers_, null);
                                }
                                else
                                    if (status_ == 403)
                                    {
                                        string responseText_ = (response_.Content == null) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                                        throw new ApiException("You do not have correct permissions to access this resource", status_, responseText_, headers_, null);
                                    }
                                    else
                                        if (status_ == 500)
                                        {
                                            ...
                                            throw new ApiException<APIError>("Internal server error", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                                        }
                                        else
                                        {
